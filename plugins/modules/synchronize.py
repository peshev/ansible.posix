...
notes:
   ...
   - Currently, M(ansible.posix.synchronize) is limited to elevating permissions via  sudo.
     This now even works when password entry is required. and rsync doesn't give us a way to pass sudo credentials in.
